...
I am always saddened me when smart, educated, accomplished people say
...
rote multiplication tables and strict adherence to notation over understanding.
...
To describe mathematics as learned adherence to notation is like describing the carpenter as
...
Berry's first argument is about equality vs equivalence:
...
But the bananas in Berry's example have no such context, other than one she artificially creates.
...
has apparently discovered this wonderfully intuitive property of multiplication.
...
it would be more intuitive to explain that when I count things by multiplication,
...
counting of whole numbers should follow a similar structure (albeit wholly artificial due to pedagogy not discovery).
This argument is so baffling to me, as to render it nonsensical. This poor kid who has discovered the commutative property
...
The nonsensical nature of the javascript and matrix math arguments reveal a dogma deeply entrenched math education.
...
tells her story of being quick, accurate, and adept at strict adherence to notation, leading to success in math until the
